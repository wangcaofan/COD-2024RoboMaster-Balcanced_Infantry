...
VMC_Info_Typedef Left_VMC_Info={
   ...
   .Phi4 = &Damiao_Motor[Left_Posterior_Joint].Data.Position,
	 .Predict_Phi1 = &Damiao_Motor[Left_Anterior_Joint].Data.Predict_Position,
	 .Predict_Phi4 = &Damiao_Motor[Left_Posterior_Joint].Data.Predict_Position,
	 .Leg_length_Change = 0,
};
...
//  if(remote_ctrl.rc.s[0]==1){
	// *Left_VMC_Info.Phi1 = 3.141593f + (Damiao_Motor[2].Data.Position);
	 ...
	 VMC_Calculate(&Left_VMC_Info);
		VMC_Predict_Calculate(&Left_VMC_Info);
...
//	  VMC_Info->Phi0_dot = (VMC_Info->Phi0 - VMC_Info->Last_Phi0)/0.00125f;
...
static void VMC_Predict_Calculate(VMC_Info_Typedef *VMC_Info){
    ...
    VMC_Info->Phi0_dot =   (VMC_Info->Predict_Phi0-  VMC_Info->Phi0)/0.001f;
